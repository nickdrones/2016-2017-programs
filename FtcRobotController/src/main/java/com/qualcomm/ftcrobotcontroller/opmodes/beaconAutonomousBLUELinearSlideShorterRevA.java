...
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.DRIVE_QUICKLY_STRAIGHT_TO_LINE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.DRIVE_SLOWLY_TILL_FIND_LINE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.DRIVE_STRAIGHT_FROM_WALL;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.DRIVE_TILL_TOUCH;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.DRIVE_TO_VORTEX;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.DRIVE_TILL_TOUCH2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.SLIDE_SLOWLY_TILL_LINE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.STOP1;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.STOP2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.STOP3;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.STOP4;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.STOP_FINAL;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.STOP_ON_LINE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.STOP_ON_WALL;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.STOP_RESET_CAPTURE_POSITION;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.TURN_TOWARD_LINE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.TURN_TOWARD_WALL;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.TURN_TOWARD_VORTEX;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.CHECK_COLOR_LOGIC1;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.CHECK_COLOR_LOGIC2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.WAIT_FOR_PUSH1;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.WAIT_FOR_PUSH2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.BACK_UP_FROM_BEACON1;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.BACK_UP_FROM_BEACON2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.SLIDE_TO_OTHER_BEACON;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousBLUELinearSlideShorterRevA.State.STOP_AFTER_BACKING_UP;


public class beaconAutonomousBLUELinearSlideShorterRevA extends Error404_Hardware_Tier2

{
  ///////////////////////////////////////////////////////////////////
    ...
    public beaconAutonomousBLUELinearSlideShorterRevA()
  {
  }
