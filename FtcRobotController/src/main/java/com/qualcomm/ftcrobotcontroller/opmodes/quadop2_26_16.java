...
public class quadop2_26_16 extends OpMode {
  ...
  public void init() {
    ...
    tapemeasure = hardwareMap.dcMotor.get("tapemeasure");
        /*
These lines check for the motors in the configuration file. The program applies the name of the motor in the program (typed first) to the name of the motor
 ...
 */
    ...
    leftFlipperposition = 0.0;               //if gamepad 2 button x is pressed, move the debris flippers back to the starting position
  ...
  public void loop() {
    ...
    {                               // Normal code is below the if loop
      ...
      if (gamepad1.dpad_left) {
        leftFlipperposition = 0.6;                     //if gamepad 2 button a is pressed, move the debris flippers such that they make a triangle in front of the robot
