...
public class meccanumLaunchControl_new extends OpMode {
  ...
  /////////////////////////////////////////
    ...
    float LF =(yL_val+xR_val+xL_val);  // mecanum drive. The left joystick controls moving
  ...
  /////////////////////////////////////
   ...
   /////////////////////////////////////////////////////////////
    ...
    launchpower1=Range.clip(launchpower1, -1, 1); //clip the launcher power to keep in within acceptable range
