...
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.BACK_UP_FROM_BEACON1;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.BACK_UP_FROM_BEACON2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.CHECK_COLOR_AMOUNTS;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.CHECK_COLOR_AMOUNTS2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.CHECK_COLOR_LOGIC1;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.CHECK_COLOR_LOGIC2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.DRIVE_QUICKLY_STRAIGHT_TO_LINE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.DRIVE_SLOWLY_TILL_FIND_LINE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.DRIVE_STRAIGHT_FROM_WALL;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.DRIVE_TILL_TOUCH;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.DRIVE_TILL_TOUCH2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.DRIVE_TO_BLOCK;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.MOVE_LEFT;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.MOVE_LEFT2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.MOVE_RIGHT;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.MOVE_RIGHT2;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.RECOVERY;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.SLIDE_SLOWLY_TILL_LINE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.SLIDE_TO_OTHER_BEACON;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.STOP3;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.STOP4;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.STOP_AFTER_BACKING_UP;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.STOP_FINAL;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.STOP_ON_LINE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.STOP_ON_WALL;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.STOP_RESET_CAPTURE_POSITION;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.TBD_CODE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.TURN_TOWARD_LINE;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.TURN_TO_BLOCK;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.TURN_TOWARD_WALL;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.WAIT_FOR_PUSH1;
import static com.qualcomm.ftcrobotcontroller.opmodes.beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER.State.WAIT_FOR_PUSH2;


public class beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER extends Error404_Hardware_Tier2

{
  ///////////////////////////////////////////////////////////////////
    ...
    public beaconAutonomousREDLinearSlideShorterRevA2_7_BLOCKS_AFTER()
  {
  }
